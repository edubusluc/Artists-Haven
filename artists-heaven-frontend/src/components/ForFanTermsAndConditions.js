...
const ForFanTermsAndConditions = () => {
          ...
          <div className="space-y-8">
            ...
            >
              <h2 className="text-2xl font-semibold text-gray-800 border-l-4 border-blue-500 pl-3 mb-2">
                {t('forFanTermdAndConditions.useTitle')}
              </h2>
              <p className="text-gray-700 inter-400 text-sm leading-relaxed">
                {t('forFanTermdAndConditions.use')}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-2xl font-semibold text-gray-800 border-l-4 border-green-500 pl-3 mb-2">
                {t('forFanTermdAndConditions.commercialTitle')}
              </h2>
              <p className="text-gray-700 inter-400 text-sm leading-relaxed">
                {t('forFanTermdAndConditions.commercial')}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-2xl font-semibold text-gray-800 border-l-4 border-purple-500 pl-3 mb-2">
                {t('forFanTermdAndConditions.lawTitle')}
              </h2>
              <p className="text-gray-700 inter-400 text-sm leading-relaxed">
                {t('forFanTermdAndConditions.law')}
              </p>
            </motion.div>
          </div>
        </motion.div>
...
export default ForFanTermsAndConditions;
