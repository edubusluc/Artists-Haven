    ...
    return (
        <>
            ...
            >
                ...
                >
                    <div className="flex flex-col gap-6 p-4 h-full items-center">
                        {/* Imágenes secundarias encima */}
                        <div className="flex gap-4 w-full justify-center overflow-x-visible px-4 py-2">
                            {product.images?.map((image, index) => (
                                <div
                                    key={index}
                                    className="w-10 h-10 rounded-md cursor-pointer shadow-lg hover:shadow-2xl transition-shadow duration-300 bg-white"
                                    style={{ flexShrink: 0 }}
                        ...
                        {/* Imagen principal */}
                        <div className="bg-white shadow-lg rounded-lg p-4 flex justify-center items-center max-w-4xl w-full">
                            <img
                                    ...
                                    {product.sizes &&
                                        Object.entries(product.sizes)
                                            ...
                                            .map(([size]) => (
                                                <label
                                                    key={size}
                                                    className={`cursor-pointer px-4 py-2 text-sm font-medium ${selectedSize === size
